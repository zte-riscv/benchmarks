...
cd json
if go build -ldflags="-s -w" -o "../$OUTDIR/json-riscv64"; then
...
cd garbage
if go build -ldflags="-s -w" -o "../$OUTDIR/garbage-riscv64"; then
...
cd gc_latency
if go build -ldflags="-s -w" -o "../$OUTDIR/gc_latency-riscv64"; then
